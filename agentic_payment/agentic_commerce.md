...
Agentic Commerce 的兴起为云服务提供商创造了多个机会：

- **基础设施层**：Agent 交易需要低延迟、高可用的计算和网络基础设施，这直接拉动云服务需求
- **身份与安全**：W3C VC 签发、密钥管理、Passkey 服务等安全基础设施需求激增
- **支付处理**：Amazon Pay 可以作为 AP2/UCP 的支付后端，参与开放协议生态
- **商户工具**：为商户提供多协议接入的统一 SDK/API Gateway，降低碎片化带来的集成成本
- **合规服务**：帮助商户满足 EU AI Act、PSD3 等监管要求的合规工具
...
- a]16z — *The Agentic Commerce Opportunity* 研究报告
