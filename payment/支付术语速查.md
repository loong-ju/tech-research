...
| **OFAC** | Office of Foreign Assets Control 海外资产控制办公室 | 🇺🇸 美国财政部 | **制裁**：维护 **SDN 名单**，"长臂管辖"任何美元清算交易（详见 `03-tech-aws §4.1`）。与 FinCEN 是财政部下两兄弟 |
...
| **sanctions screening** | 制裁名单筛查 | 把交易方/UBO 与 OFAC/UN/EU/HMT 名单做模糊匹配（实现原理见 `03-tech-aws §4.1 ③′`） |
