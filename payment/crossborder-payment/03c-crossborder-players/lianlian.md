...
> - ⚠️ **关于"全球收单(Global Acquiring)"产品线**：连连官网**确把它列为正式产品**（自称支持 Shopify/6大卡组/数百本地支付、"国内首家 Amex 直连""Visa/MC 主会员"）——但这是**公司营销自述、不绑定任何具体国别牌照、无第三方佐证**，且**非主战场**（主力是跨境收款，§6 卡收单条已注）。所以它**不改变"连连在巴西/中东无独立可核实的本地收单牌照与业务"**这一结论。
...
#### 4.2.1 连连到底是哪些卡组织的会员？——做收单的第②层资格 📌招股书一手

> 🔑 **做卡收单需两层资格**：① 监管牌照(政府发，§4 那堆)；② **卡组织收单会员资格(Visa/MC 等发，Principal Member 才能直连清算)**。§4 只覆盖了①，这一节查②。

- 📌 **招股书一手(HKEX 2024-03-20, p.274)**：连连**仅在中国大陆 + 新加坡两个法域是卡组织主会员(principal member)**，可在这两地"直接通过 Amex/UnionPay/Visa/MasterCard 清算机构提供收单"；**其他所有法域，连连靠当地持牌合作金融机构(sponsor)间接提供收单**——而非自有卡组织会员资格。
- 🔑 **这正解释了"有 MTL/EMI 就能收单吗"**：① 美国 MTL、香港 MSO、中国连连银通牌照**范围本身不含卡收单**；② 新加坡 MPI、卢森堡 EMI **范围含**收单，但连连**只在新加坡有卡组织主会员资格**(中国大陆+新加坡两地)，**欧盟等地即便牌照范围含收单也得挂靠 sponsor**；③ 即便能做，**实际主力仍是收款**，不做海外本地受理消费者刷卡。
- ⚠️ **官网营销自述无独立佐证**：连连官网"全球收单"页自称"**Visa/MC 主会员认证**""**国内首家 Amex 卡组直连的线上收单机构**""与六大卡组全面合作"——但**经多源检索零卡组织官方名册/第三方佐证**(Wikipedia、官网 about/合规页均不提任何会员等级)；独立媒体只核到更窄事实:2022-05 连连是"首家上线 Amex 境外卡线上收单业务的非银行支付机构"(≠卡组直连)。JCB/Discover 仅"建立合作"软措辞、无会员证据。
- 🔑 **别把"连通(LianTong)"当连连的收单会员**：连连与 Amex 在华是合资**清算机构连通**(四方模型的**清算/转接 switching 层**，2020-06 央行清算牌照)——连连是其股东(已降至 45.22%、运通 54.78% 为第一大股东、2025 报道升至 82%+)，这是**清算层**角色，**不是"连连作 Amex 收单成员"**。
- ⚠️ **可信度**：连连"中国大陆+新加坡主会员"出自**招股书(法律责任文件，强)**，但仍是公司自述、**非 Visa/MC 官方名册独立核实**；官网"主会员认证/Amex 直连"纯营销、零佐证。⚠️ 招股书"中国大陆主会员可直接通过 Visa/MC 清算"一句**存疑**(与中国境内人民币清算长期由银联垄断、外资网络境内清算受限的现实可能冲突)，确切含义待进一步核。
...
#### 卡收单 / 全球收单(Global Acquiring)⚠️营销自述
- **定位**：境内外商户收卡(Visa/MC/银联)，含线上+线下(POS)；官网设"全球收单"产品线。
- **功能**：受理 Visa/MC/银联等卡支付，面向商户提供收单通道。⚠️ **官网自述**：支持 Shopify 等 20+ 建站平台、接入 6 大国际卡组、支持欧美/拉美/亚太/非洲数百种本地支付，自称"国内首家 Amex 卡组直连""Visa/MC 主会员(Principal Member)"——**均为公司文案，无 Visa/MC/Amex 官方或监管第三方佐证**。
- **市场位置**：🔧 境内卡收单市场被银联商务/拉卡拉/通联支付等传统收单行垄断；海外市场 Stripe/Adyen/Checkout.com 主导。连连卡收单**非主战场**(主力是跨境收款)，是产品线补充。
- ⚠️ **关键边界**：官网"全球收单"产品页**不绑定任何具体国别收单牌照**（仅笼统称"依托全球牌照布局，与各地领先金融机构合作"，暗示依赖伙伴牌照）；连连在巴西/中东**无独立可核实的本地收单牌照**（§4.1 已核）。这条产品线**与连连"跨境收款回国"主场是两回事**。
