...
| 2026-05-19 | **获迪拜 DFSA 第3D类支付牌照**(中东首张持牌，DIFC 法域内支付/跨境结算，非卡收单)📌港股公告 |

> 战略主线：单点第三方支付 → 跨境电商支付 → 全球牌照网络 → 港股上市 → 押注香港虚拟资产/稳定币 + AI 原生 → **进军中东(DIFC)**。
...
**按持牌实体逐个**（📌 招股书"监管概览"+主要子公司表）。**"业务范围"列填连连用这张牌照实际干什么**（⚠️ 不是"牌照范围理论可做什么"——尤其收单见下方注）：
| # | 实体 | 牌照 | 监管/法域 | 业务范围（实际用途） | 时间 |
|---|---|---|---|---|---|
| ① | **连连银通电子支付**(2003成立, 注册资本3.25亿; "连连支付"品牌持牌主体) | **互联网支付/移动电话支付**(央行《支付业务许可证》) | 中国央行 | 境内收付、结售汇回境 ⚠️**非"银行卡收单"类牌照** | 2011 |
| ② | **连通(杭州)技术服务 LianTong**(与运通合资) | **银行卡清算业务许可证(中国首家中外合资)** | 中国央行 | **卡清算/转接(switching)**——四方模型的清算层，⚠️**非收单**；连连仅持股(2023降至45.22%、运通54.78%为第一大股东) | 2020-06 |
| ③ | 连连(香港) | 金钱服务经营者 **MSO** | 香港海关 | 跨境收款、换汇、资金转移 ⚠️非卡收单 | 2017 |
| ④ | **DFX Labs**(全资) | **VATP**(第1类+第7类) | 香港 SFC | 虚拟资产交易(战略新曲线) | 2024-12 |
| ⑤ | **连连星球 StarFX**(全资) | **第3类 杠杆式外汇** | 香港 SFC | 外汇保证金交易 | 2025-08 |
| ⑥ | **LLPay**(美国) | **全美50州+DC MTL** + FinCEN MSB | 美国各州/FinCEN | 海外**代收(收款)**+资金转移 ⚠️**MTL范围不含卡收单** | 2021 集齐 |
| ⑦ | **LL Pay UK**(LLUK) | FCA **授权支付机构 API** | 英国 FCA | 收款+跨境付 | 2018 |
| ⑧ | **Starlink**(2018成立) | **主要支付机构 MPI** | 新加坡 MAS | 收款+跨境付；⚠️**新加坡是连连少数的"卡组织主会员"法域之一**(招股书,见 §4.2)——理论可直接收单，但实际主力仍是收款 | 2021 |
| ⑨ | 卢森堡实体 | **电子货币机构 EMI**(EEA passporting) | 卢森堡 CSSF | 收款+换汇；⚠️EMI范围(PSD2)理论含 acquiring，但连连**未持当地卡组织主会员**、未实际做本地收单 | 2024-05 |
| ⑩ | 印尼经营实体 | VIE 式合同安排开展支付 | 印尼 | 本地收款 | — |
| ⑪ | 加拿大收购实体 | **MSB** | FINTRAC | 外汇/汇款/资金转移 | 2026-04 |
| ⑫ | **迪拜实体**(中东首张) | **DFSA 第3D类支付牌照** | 迪拜 **DFSA**(限 DIFC) | 跨境支付/结算(与本地银行合作开客户资金账户) ⚠️**非卡收单** | **2026-05-19** 📌港股公告 |
| ⑬ | 日本/越南/巴西等 | 业务受当地法规约束 | — | 本地收款；**巴西仅"外汇业务资质"，无 BCB 支付/收单牌照** | — |

> 🔑 **"业务范围"列为何几乎全是"收款"而非"收单"——这正是连连主场的本质**：① **多数牌照(MTL/MSO/MSB)的范围本身不含卡收单**；② **少数范围含收单的(新加坡 MPI、卢森堡 EMI)**，连连**只在中国大陆+新加坡是卡组织主会员**(§4.2)、其余法域**靠挂靠 sponsor**，且**实际主力仍是收款**，不做海外本地受理消费者刷卡。所以填"收款"是据实，不是填"收单"。

⚠️ 完整逐项清单(各州 MTL 视作多项、各类资质，媒体口径 2026-05 累计约 66 项)公司未穷举，需查各国监管名录(美 NMLS/MAS/FCA/CSSF/HK SFC/FINTRAC/DFSA)。⚠️ **DFSA(2026-05新获)截至本研究尚未补入官网牌照墙**，依据港股公告+DIFC官方页(DFSA 名册未直读核)。
...
> 💡 **常见追问：为什么这条资金链没有"海外本地收单(acquiring)"这一环？连连在中东/巴西不是也有牌照吗？**（经 deep-research 核查，2026-06）
> - 🔑 **连连主场是"跨境收款回国"，不是"海外本地收单"**——它从"平台已收好货款、要 payout 给卖家"那一环接入，**不受理当地消费者刷卡**（与 PayerMax/dLocal 这类"海外本地收单"玩家**主场相反**，见 `payermax.md`）。所以这条 Amazon 收款链天然没有"收单"环节，是对的。
> - 📌 **中东（DFSA，2026-05 新进展）**：连连确获迪拜 **DFSA 第3D类支付牌照**，但那是 **DIFC 法域内的支付/跨境结算业务**（与本地银行合作开客户资金账户），**不是受理当地消费者卡支付的本地收单**；沙特 SAMA、阿联酋联邦 CBUAE/ADGM **无牌照证据**。
> - 📌 **巴西**：连连官网牌照墙巴西**只列"外汇业务资质"**，**无 BCB 支付机构/收单牌照**；巴西站定位"跨境收款工具"，**不做本地收单**。
> - ⚠️ **关于"全球收单(Global Acquiring)"产品线**：连连官网（含开发者文档站 `doc.lianlianpay.com`，有完整 API/SDK/四种集成模式/插件，证明这是**认真在做的产品线**）**确把它列为正式产品**，自称支持 Shopify/6大卡组/数百本地支付、"国内首家 Amex 直连""Visa/MC 主会员"。这些会员声明**因卡组织不公开主会员名册而无第三方核实渠道**（属该类信息固有属性、非可疑信号，详见 §4.2.1）；且官网自陈"依托全球牌照布局、**与各地领先金融机构合作**"——即**多数法域靠挂靠 sponsor**、**非主战场**(主力是跨境收款)。**不改变"连连本地收单只在中国大陆+新加坡自持、其余挂靠"这一结论。**
...
#### 4.2.1 连连在各区域做什么业务？收款 vs 本地收单、自持 vs 挂靠 sponsor（核心总表）📌招股书一手

> 🎯 **这一节回答最核心的问题**：连连在哪些区域、开展了什么类型的业务（只是跨境收款，还是也做本地收单）？收单是**自持卡组织会员直接做**，还是**挂靠 sponsor**？sponsor 是谁？

**先讲两个前提（呼应 `支付术语速查 §3.1` 收单三层资格）**：做卡收单需 ① 监管牌照（政府发，§4 那堆）+ ② **卡组织收单会员资格**（Visa/MC 发，Principal Member 才能直连清算）。§4 只覆盖①，这里看②与实际业务。

📌 **招股书一手（HKEX 2024-03-20, p.274）**：连连**仅在中国大陆 + 新加坡两个法域是卡组织主会员（principal member）**，可在这两地"直接通过 Amex/UnionPay/Visa/MasterCard 清算机构提供收单"；**其他所有法域靠当地持牌合作金融机构（sponsor）间接提供收单**。

**区域 × 业务类型 × 收单方式 总表：**

| 区域 | 实际开展的业务 | 是否做本地收单 | 收单方式（自持 vs 挂靠） | sponsor 是谁 |
|---|---|---|---|---|
| **中国大陆** | 境内收付、结售汇回境、卡清算(经连通) | ⚠️ 招股书称是主会员、理论可直接收单 | **自持**(主会员)⚠️但"直连Visa/MC"存疑(境内银联垄断) | — |
| **新加坡** | 跨境收款+跨境付 | ⚠️ 招股书称主会员、理论可直接收单(实际主力仍收款) | **自持**(主会员) | — |
| **美国** | 海外**代收(收款)**+资金转移 | ❌ 否(MTL范围不含卡收单) | — | — |
| **欧盟/英国** | 收款+换汇 | ❌ 实际不做(EMI范围理论含收单,但非主会员) | **若做须挂靠** | ⚠️**未披露具体名** |
| **巴西/拉美** | 本地收款+全球付 | ❌ 否(仅外汇资质、无BCB收单牌照) | — | — |
| **中东(迪拜)** | 跨境支付/结算(DFSA,2026-05新) | ❌ 否(支付/结算类,非收单) | — | — |
| **"全球收单"产品**(官网) | 一站式收单接入(Shopify/数百本地支付) | ✅ 产品线存在 | **挂靠**——官网自陈"依托全球牌照布局、**与各地领先金融机构合作**" | ⚠️**未披露具体名** |

> 🔑 **总结(你要的答案)**：
> - **连连主场是"跨境收款回国"**，覆盖美/欧/英/新/印尼/巴西/日越/加/中东——**绝大多数区域只做收款(代收平台货款+换汇+结售汇回国)，不做本地收单**。
> - **本地收单(acquiring)只在极少数法域具备自持资格**：**仅中国大陆+新加坡是卡组织主会员**(招股书),其余法域即便有"全球收单"产品，也是**挂靠当地 sponsor 金融机构**间接做。
> - ⚠️ **sponsor 具体是谁——招股书只说"当地持牌合作金融机构(local financial institutions)"，未点名任何具体银行/收单行**；官网亦只笼统称"与各地领先金融机构合作"。**具体 sponsor 名单未披露、待核。**

**官网"主会员/Amex直连"声明怎么看（标法纠偏）：**

- 连连官网(`global.lianlianpay.com` 与开发者文档站 `doc.lianlianpay.com` 一致)称"**Visa/MC 主会员(Principal Member)认证**""**国内首家 Amex 卡组直连的线上收单机构**""与六大卡组全面合作"。
- ⚠️ **关于"无第三方佐证"的正确理解（重要，避免武断）**：**卡组织本身不公开"主会员"完整名册**——Visa 仅有"服务商/代理注册(Registry of Service Providers)"、那不是主会员名册，Mastercard/Amex/JCB/Discover 无公开会员清单。所以"某机构是不是主会员"**天然无法被第三方独立证实或证伪**，这是该类信息的固有属性，**不构成"可疑"信号**。因此：
  - "中国大陆+新加坡主会员" = 📌 **招股书披露（法律责任文件，可信度高）**，只是无公开名册可旁证；
  - "Amex 直连/国内首家/六大卡组合作" = 🔧 **公司声明**，卡组织无公开名册可核——**既不当已证实事实引用，也不推定为不实**；独立媒体只核到更窄事实:2022-05 连连是"首家上线 Amex 境外卡线上收单业务的非银行支付机构"(≠卡组直连)；JCB/Discover 措辞是"合作"非会员。
- 🔑 **别把"连通(LianTong)"当连连的收单会员**：连连与 Amex 在华是合资**清算机构连通**(四方模型的**清算/转接 switching 层**，2020-06 央行清算牌照)——连连是其股东(已降至 45.22%、运通 54.78% 第一大股东、2025 报道升至 82%+)，是**清算层**角色，**不是"连连作 Amex 收单成员"**。

> ⚠️ **可信度**：区域业务类型、"中国大陆+新加坡主会员"、其余靠合作机构——均出自**招股书(法律责任文件，强)**；但卡组织主会员**无公开名册可独立核**(见上)。⚠️ 招股书"中国大陆主会员可直接通过 Visa/MC 清算"一句**存疑**(与境内银联垄断、外资网络境内清算受限的现实可能冲突)，确切含义待核。⚠️ **sponsor 具体名、各地"全球收单"实际依托哪家合作机构——未披露，待核。**
...
#### 卡收单 / 全球收单(Global Acquiring)⚠️非主战场·多靠挂靠
- **定位**：境内外商户收卡(Visa/MC/银联)，含线上+线下(POS)；官网设"全球收单"产品线。
- **功能**：受理 Visa/MC/银联等卡支付，面向商户提供收单通道。官网(含开发者文档站 `doc.lianlianpay.com`)自述支持 Shopify 等 20+ 建站平台、接入 6 大国际卡组、数百种本地支付，自称"国内首家 Amex 卡组直连""Visa/MC 主会员(Principal Member)"——这些会员声明**因卡组织不公开主会员名册而无第三方核实渠道**（属该类信息固有属性，非可疑信号；详见 §4.2.1 标法说明）。
- **市场位置**：🔧 境内卡收单市场被银联商务/拉卡拉/通联支付等传统收单行垄断；海外市场 Stripe/Adyen/Checkout.com 主导。连连卡收单**非主战场**(主力是跨境收款)，是产品线补充。
- ⚠️ **关键边界**：本地收单**只在中国大陆+新加坡自持**(招股书主会员)，其余法域官网自陈"依托全球牌照布局、与各地领先金融机构合作"=**挂靠 sponsor**(具体 sponsor 名未披露)；巴西/中东**无本地收单牌照**(§4.1)。详见 §4.2.1 区域总表。
