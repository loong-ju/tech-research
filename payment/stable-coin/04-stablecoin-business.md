...
- **CBDC/mBridge（央行版共同账本）** → `跨境支付深度研究报告.md` 第八部分 + `跨境支付学习笔记.md` 管道④
...
**Q：稳定币和 CBDC 什么区别？**
A：同思路（链上账本），不同发行人。稳定币是**私人公司**发的（Circle/Tether），是"私人借条"，你信公司；CBDC 是**央行**发的数字法币，是"钱本身"（最硬的央行货币）。货币等级上 CBDC > 商业银行货币 > 稳定币。详见 `跨境支付学习笔记.md` 管道③④对比。
