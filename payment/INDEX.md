...
├── epayment/                  维度一·模块2：电子支付（网关/钱包/电商场景/企业画像）
...
## 🌍 维度一：传统支付（card-payment 银行卡 / epayment 电子支付 / crossborder 跨境）
...
| 维度 | 对应管道 | 核心问题 |
|---|---|---|
| 传统支付(card/epayment/crossborder) | ① 代理行电汇 + ② 卡组织 | 跨境没有共同账本，靠接力/封闭网络解决 |
