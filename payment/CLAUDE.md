...
| `crossborder-payment/` | **传统支付·跨境** | 跨境支付四套管道、代理行电汇、SWIFT、各国清算系统(Fedwire/CHIPS/CHAPS/T2/CIPS)、外汇、跨境收款全链路、跨境贸易结算方式、跨境收款企业画像(03c) |
...
### crossborder-payment/ — 传统支付·跨境（模块3）
...
四套管道 = 四种答案：
  ① 代理行电汇 — 靠中间银行接力打补丁（crossborder-payment）
